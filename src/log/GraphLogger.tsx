...
const positionColorObject = {
    ...
    'rightShoulderX': 'rgb(192, 0, 0)',
    'leftShoulderY': 'rgb(0, 0, 255)',
    'rightShoulderY': 'rgb(0, 0, 192)',
    'leftHipY': 'rgb(255, 128, 0)',
    'rightHipY': 'rgb(192, 64, 0)',
    'leftHipX': 'rgb(0, 192, 255)',
    'rightHipX': 'rgb(0, 128, 192)',
    'leftKnee': 'rgb(0, 255, 0)',
    'rightKnee': 'rgb(0, 192, 0)',
    'leftAnkle': 'rgb(255, 0, 255)',
    'rightAnkle': 'rgb(192, 0, 192)',
}
